  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] pb-24 lg:pb-8">
      ...
      <div className="px-5 lg:px-8">
        <p className="text-gray-700 font-semibold mb-3">{t("quickActions")}</p>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4 gap-3 lg:gap-4">
          <Link href={`/${locale}/groups`}>
            <Card className="bg-[#E0F2FE] border-0 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
          ...
          <Link href={`/${locale}/add-expense`}>
            <Card className="bg-[#D1FAE5] border-0 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="w-10 h-10 rounded-xl bg-emerald-500/20 flex items-center justify-center mb-3">
                  <ReceiptIcon className="w-5 h-5 text-emerald-600" />
                </div>
                <p className="font-semibold text-gray-800">{t("addExpense")}</p>
                <p className="text-gray-500 text-sm mt-1">
                  {t("addExpenseDesc")}
                </p>
              </CardContent>
          ...
          <Link href={`/${locale}/settle`}>
            <Card className="bg-[#FED7AA] border-0 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                ...
                <p className="font-semibold text-gray-800">{t("settle")}</p>
                <p className="text-gray-500 text-sm mt-1">{t("settleDesc")}</p>
              </CardContent>
            </Card>
          </Link>

          <Card className="bg-[#F3F4F6] border-0 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
            <CardContent className="p-4">
              <div className="w-10 h-10 rounded-xl bg-gray-500/20 flex items-center justify-center mb-3">
                <ClockIcon className="w-5 h-5 text-gray-600" />
              </div>
              <p className="font-semibold text-gray-800">{t("history")}</p>
              <p className="text-gray-500 text-sm mt-1">{t("historyDesc")}</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="px-5 lg:px-8 mt-6">
        <div className="flex items-center justify-between mb-3">
          <p className="text-gray-700 font-semibold">{t("recentGroups")}</p>
          <Link
            href={`/${locale}/groups`}
